...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        mainWindow.resize(1387, 818)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        brush = QtGui.QBrush(QtGui.QColor(135, 147, 92))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
        brush = QtGui.QBrush(QtGui.QColor(202, 220, 138))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Light, brush)
        brush = QtGui.QBrush(QtGui.QColor(168, 183, 115))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Midlight, brush)
        brush = QtGui.QBrush(QtGui.QColor(67, 73, 46))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Dark, brush)
        brush = QtGui.QBrush(QtGui.QColor(90, 98, 61))
        brush.setStyle(QtCore.Qt.SolidPattern)
        ...
        brush = QtGui.QBrush(QtGui.QColor(195, 201, 173))
        brush.setStyle(QtCore.Qt.SolidPattern)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        brush = QtGui.QBrush(QtGui.QColor(142, 189, 194))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
        brush = QtGui.QBrush(QtGui.QColor(223, 252, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Light, brush)
        brush = QtGui.QBrush(QtGui.QColor(182, 220, 224))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Midlight, brush)
        brush = QtGui.QBrush(QtGui.QColor(71, 94, 97))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Dark, brush)
        brush = QtGui.QBrush(QtGui.QColor(95, 126, 129))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Mid, brush)
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Shadow, brush)
        brush = QtGui.QBrush(QtGui.QColor(198, 222, 224))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.AlternateBase, brush)
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 220))
        brush.setStyle(QtCore.Qt.SolidPattern)
...
"    border-image: url(:/img/icon/bg.jpg);\n"
...
"}")
        ...
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(75, 75, 75, 200))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
        brush = QtGui.QBrush(QtGui.QColor(75, 75, 75, 200))
        brush.setStyle(QtCore.Qt.SolidPattern)
...
"border-radius:0px;}")
        ...
        self.detectpushButton = QtWidgets.QPushButton(self.groupBox_2)
        ...
        self.detectpushButton.setStyleSheet("font-size: 25px;\n"
"    font-family: \"Microsoft YaHei\";\n"
"    font-weight: bold;\n"
"         border-radius:9px;\n"
"        background:rgba(66, 195, 255, 0);\n"
"    color: rgb(255, 255, 255);")
        ...
        self.horizontalLayout_35.addWidget(self.detectpushButton)
        spacerItem1 = QtWidgets.QSpacerItem(12, 20, QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_35.addItem(spacerItem1)
        self.showpushButton_2 = QtWidgets.QPushButton(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.showpushButton_2.sizePolicy().hasHeightForWidth())
        self.showpushButton_2.setSizePolicy(sizePolicy)
        self.showpushButton_2.setStyleSheet("font-size: 25px;\n"
"    font-family: \"Microsoft YaHei\";\n"
"    font-weight: bold;\n"
"         border-radius:9px;\n"
"        background:rgba(66, 195, 255, 0);\n"
"    color: rgb(255, 255, 255);\n"
"")
        self.showpushButton_2.setObjectName("showpushButton_2")
        self.horizontalLayout_35.addWidget(self.showpushButton_2)
...
"")
        ...
        self.stackedWidget.setStyleSheet("background-color: rgb(0,0,0,0);\n"
"")
        self.stackedWidget.setObjectName("stackedWidget")
        self.page = QtWidgets.QWidget()
        self.page.setObjectName("page")
        self.groupBox_201 = QtWidgets.QGroupBox(self.page)
        self.groupBox_201.setGeometry(QtCore.QRect(0, 0, 1071, 741))
...
"background-color: rgba(223, 223, 223, 150);}")
        ...
        self.groupBox_6.setGeometry(QtCore.QRect(0, 0, 1071, 741))
        self.groupBox_6.setStyleSheet("background-color: rgba(95, 95, 95, .6);\n"
"border: 0px solid #42adff;\n"
"border-left: 1px solid rgba(200, 200, 200,100);\n"
"border-right: 0px solid rgba(29, 83, 185, 255);\n"
"border-radius:0px;\n"
"")
        ...
        self.modelButton = QtWidgets.QPushButton(self.groupBox_6)
        self.modelButton.setGeometry(QtCore.QRect(870, 40, 191, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.modelButton.sizePolicy().hasHeightForWidth())
        self.modelButton.setSizePolicy(sizePolicy)
        self.modelButton.setStyleSheet("font-size: 18px;\n"
"    font-family: \"Microsoft YaHei\";\n"
"    font-weight: bold;\n"
"         border-radius:9px;\n"
"        border : 0px;\n"
...
"    color: rgb(255, 255, 255);")
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(0, 80, 1071, 661))
        self.formLayoutWidget.setObjectName("formLayoutWidget")
        self.formLayout = QtWidgets.QFormLayout(self.formLayoutWidget)
        self.formLayout.setContentsMargins(0, 0, 0, 0)
        self.formLayout.setObjectName("formLayout")
        self.groupBox_7 = QtWidgets.QGroupBox(self.groupBox_6)
        self.groupBox_7.setGeometry(QtCore.QRect(0, 0, 1071, 42))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.groupBox_7.sizePolicy().hasHeightForWidth())
        self.groupBox_7.setSizePolicy(sizePolicy)
        self.groupBox_7.setMinimumSize(QtCore.QSize(0, 42))
        self.groupBox_7.setMaximumSize(QtCore.QSize(16777215, 42))
        self.groupBox_7.setStyleSheet("background-color: rgba(0, 0,0, 0);\n"
"border: 0px solid #42adff;\n"
"border-left: 1px solid rgba(200, 200, 200,100);\n"
"border-right: 0px solid rgba(29, 83, 185, 255);\n"
"border-radius:0px;\n"
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "YOLOv5甲骨字检测界面"))
        self.label_4.setText(_translate("mainWindow", "甲骨检测与展示界面"))
        self.detectpushButton.setText(_translate("mainWindow", "甲骨预测"))
        self.showpushButton_2.setText(_translate("mainWindow", "甲骨展示"))
        ...
        self.label_6.setText(_translate("mainWindow", "检测界面"))
        self.modelButton.setText(_translate("mainWindow", "上传文件"))
        self.label_7.setText(_translate("mainWindow", "  展示界面"))
